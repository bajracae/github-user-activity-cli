...
def main():
    ...
    if args.username:
        ...
        if type(events) == dict:
            exit(f"User {args.username} not found. Please enter a valid username.")
        ...
        for event in events:
            ...
            if event_type == "CommitCommentEvent":
                ...
                elif payload_action == "updated":
                    print(f"Pull Request Review updated in {event_repo_name}.")                
                elif payload_action == "dismissed":
